...
const banner = cfonts.render(('BOT POSEIDON||Elbielzinho'), {
    font: 'chrome',
    color: 'candy',
    align: 'center',
    gradient: ["red","yellow"],
